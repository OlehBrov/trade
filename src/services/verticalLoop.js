  ...
  let onChange = config.onChange,
    ...
    populateHeights = () => {
      let b1 = container.getBoundingClientRect(),
        b2;
        items.forEach((el, i) => {
          const yPos = i % 2 === 0 ? 0 : 30
    //       gsap.set(el, {
    //       y: yPos
    //   })
      
        console.log(
          '(gsap.getProperty(el, "y", "px"))',
          gsap.getProperty(el, "y", "px")
        );
          heights[i] = parseFloat(gsap.getProperty(el, "height", "px"))
          console.log('parseFloat(gsap.getProperty(el, "height", "px"))', parseFloat(gsap.getProperty(el, "height", "px")))
        yPercents[i] = snap(
      ...
      gsap.set(items, {
        ...
        yPercent: (i) => i % 2 === 0 ? yPercents[i] : yPercents[i] + 6,
      });
